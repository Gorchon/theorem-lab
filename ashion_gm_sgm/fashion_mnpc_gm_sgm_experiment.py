...
BATCH_SIZE = 256
EPOCHS = 200          # you can increase later if needed
LR = 1e-3
LAMBDA_PENALTY = 4.0
KAPPA = 0.3
...
N_WORKERS = 11                 # number of "workers" for GM-SGM
...
# ============================================================
# 3. Helpers: model, grads, geometric median
# ============================================================
def make_model():
...
# ============================================================
# 4. Training loop (SGM / SGM+corruption / GM-SGM)
# ============================================================
def train(mode="sgm_clean"):
    """
    mode:
      - 'sgm_clean'      : no corruption
      - 'sgm_corrupt'    : SGM with gross gradient corruption
      - 'gmsgm_corrupt'  : GM-SGM with gross corruption
    """
...
# 5. Run experiments
# ============================================================
print("\n=== Running SGM with gross corruption ===")
sgm_corrupt_logs = train(mode="sgm_corrupt")

print("\n=== Running GM-SGM with gross corruption ===")
